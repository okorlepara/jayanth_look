...
datagroup: jayanth_lool_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: jayanth_lool_default_datagroup
...
# To see the Explore you’re building, navigate to the Explore menu and select an Explore under "Jayanth Lool"
...
explore: order_items {
  sql_always_where: ${returned_month} >= '2019-10' ;;
  join: orders {
    type: left_outer
